...
final class DictionaryTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->map = new Dictionary(['A' => 'x', 'B' => 'y', 'C' => 'z']);
    }

    public function testFromIterableEqual(): void
    {
        $fromIterable = Dictionary::fromIterable($this->map);
    ...
    {
        $fromIterable = Dictionary::fromIterable(['A' => 'x', 'B' => 'y', 'C' => 'z']);
    ...
    {
        $fromIterable = Dictionary::fromIterable(new ArrayIterator(['A' => 'x', 'B' => 'y', 'C' => 'z']));
    ...
    {
        self::assertCount(0, new Dictionary());
    }
    ...
    {
        $list = new Dictionary(['A' => new stdClass()]);
        $copy = $list->copy();
    ...
    {
        self::assertTrue((new Dictionary())->isEmpty());
    }
    ...
    {
        $counter = 0;
        foreach ((new Dictionary()) as $key => $item) {
            ++$counter;
    ...
    public function testOffsetSet(): void
    {
        ...
        $this->expectExceptionMessage('Laudis\Neo4j\Types\Dictionary is immutable');
    ...
    {
        $this->expectException(OutOfBoundsException::class);
        $this->expectExceptionMessage('Offset: "AA" does not exists in object of instance: Laudis\Neo4j\Types\Dictionary');
        $this->map['AA'];
    }
    ...
    {
        self::assertTrue(isset((new Dictionary(['a' => null]))['a']));
    }
    ...
    {
        self::assertEquals('{}', json_encode(new Dictionary(), JSON_THROW_ON_ERROR));
    }
    ...
    {
        self::assertEquals('', (new Dictionary())->join('A'));
    }

    public function testDiff(): void
    {
        $subtract = new Dictionary(['B' => 'x', 'Z' => 'z']);
    ...
    {
        $intersect = new Dictionary(['B' => 'x', 'Z' => 'z']);
    ...
    {
        $map = new Dictionary(new class() implements IteratorAggregate {
        ...
        self::assertEquals(Dictionary::fromIterable(['0' => 'x'])->toArray(), $map->toArray());
    }
    ...
    {
        $map = Dictionary::fromIterable(['a' => 'b', 'c' => 'd'])
        ...
        self::assertEquals(Dictionary::fromIterable(['a' => 'b', 'c' => 'd']), $map);
    }
